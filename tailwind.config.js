  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'ring-pulse': {
          '0%': { boxShadow: '0 0 0 0 rgba(19, 236, 30, 0.4)' },
          '70%': { boxShadow: '0 0 0 15px rgba(19, 236, 30, 0)' },
          '100%': { boxShadow: '0 0 0 0 rgba(19, 236, 30, 0)' },
        },
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 20px rgba(19, 236, 30, 0.3)' },
          '50%': { boxShadow: '0 0 35px rgba(19, 236, 30, 0.6)' },
        },
      },
      animation: {
