                            ...
                            <div key={item.id} className="flex items-center justify-between">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="flex items-center border border-gray-200 rounded-full bg-gray-50">
                                        <button onClick={() => onUpdateQuantity(item.id, item.cartQuantity - 1)} className="px-3 py-1 text-lg font-bold text-stone-600 hover:bg-gray-100 rounded-l-full">-</button>
                                        <span className="px-4 py-1 font-semibold w-12 text-center">{item.cartQuantity}</span>
                                        <button onClick={() => onUpdateQuantity(item.id, item.cartQuantity + 1)} className="px-3 py-1 text-lg font-bold text-stone-600 hover:bg-gray-100 rounded-r-full">+</button>
                                    </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
                            ...
                            <form className="space-y-4">
                                <div>
                                    ...
                                    <input type="text" id="address" className="mt-1 block w-full rounded-lg border-stone-300 shadow-sm focus:border-primary focus:ring-2 focus:ring-primary/50 sm:text-sm bg-white" />
                                </div>
                            </form>
                        </div>
