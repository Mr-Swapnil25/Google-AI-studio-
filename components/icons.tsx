...
export const SparklesIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-9l2.293-2.293a1 1 0 011.414 0l.293.293a1 1 0 010 1.414L11 11.5M13 13.5l-2.293 2.293a1 1 0 01-1.414 0l-.293-.293a1 1 0 010-1.414L12.5 13M17 3l-2.293 2.293a1 1 0 000 1.414l.293.293a1 1 0 001.414 0L19 5m-1 7l2.293 2.293a1 1 0 010 1.414l-.293.293a1 1 0 01-1.414 0L16 14.5" />
    </svg>
);
...
export const DollarSignIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8v1m0 6v1m0-1c-1.11 0-2.08-.402-2.599-.97M12 8c0-1.105-1.343-2-3-2m3 2c1.657 0 3-.895 3-2m-3 2v1m0 6v1m0-1c1.11 0 2.08.402 2.599.97M12 14c0 1.105 1.343 2 3 2m-3-2c-1.657 0-3 .895-3 2" />
    </svg>
);
